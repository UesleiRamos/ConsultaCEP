...
import com.example.consultacep.data.Endereco
import com.example.consultacep.infrastructure.event.retrofit.ApiClient
import com.example.consultacep.infrastructure.model.response.EnderecoResponse
...
class BuscarCepViewModel : ViewModel() {
    ...
    fun buscarEndereco(cep: String) {
        ApiClient.service.getEndereco(cep).enqueue(object : Callback<EnderecoResponse> {
